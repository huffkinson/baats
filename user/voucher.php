					...
					<div class="modal-dialog modal-md">
						<div class="modal-content">
							...
							<div class="modal-footer">
									<button type="submit" class="btn btn-sm btn-outline-success">Save & Proceed</button>	
						...
						<?php
							...
							while($row = mysqli_fetch_assoc($result)){?>
								<tr>
									...
									<td><a href="printvoucher.php?id=<?php echo $row['voucher_id']; ?>" class="btn btn-sm btn-secondary">Print</a></td>
								</tr>
