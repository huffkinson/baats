					...
					<?php
						...
						while($row=mysqli_fetch_assoc($result)){
							...
							<tr>
								...
								<td><a href="soadetails2.php?id=<?php echo $row['soa_id']; ?>" class="btn btn-sm btn-primary">Details</a></td>
								<td><a href="soaprint.php?id=<?php echo $row['soa_id'];?>" class="btn btn-sm btn-success">Print</a></td>
							</tr>
							<?php
							$count++;
						}
