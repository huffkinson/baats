<?php
	...
	$soa_id = $_GET['id'];
	mysqli_query($connection, "UPDATE tbl_soa set archived='yes' where soa_id='$soa_id'");
...
<div>
	...
	<div class="row">
	    ...
	    <table class="table table-borderless table-lg" align="center">
	        ...
	        <tbody>
	            <tr>
	                <td class="detail-header" colspan="5"><b>Client Name: <?php echo $clientname;?></b></td>
				...
				<tr>
				    <td class="detail-header" colspan="5"><b>Address: <?php echo $clientaddress;?></b></td>
			    </tr>
			    <tr>
			        <td class="detail-header" colspan="4" style="text-indent: 25px;"><b>Charge Description</b></td>
			        <td></td>
				    <td class="text-center detail-header"><b>Amount</b></td>
  ...
  background-repeat: no-repeat; background-position: center;opacity:0.2;"></td>
				...
				<?php
					...
					extract($temprec);?>
				    <tr>
				        <td class="description-details" colspan="2" style="text-indent: 100px;"><?php echo $temprec['soa_description'];?></td>
				        <td></td>
				        <td class="description-details" colspan="3" align="right"><?php echo number_format($temprec['soa_description_amount'],2,'.',',');?></td>
				    </tr>
				    <?php } ?>
				<tr>
					<td class="smaller-height" align="center" colspan="7"><small>* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * Nothing Follows * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *</small></td>
				</tr>
			</tbody>
	    </table>
	    </div>
	...
	<div class="row justify-content-center">
	        <table class="table table-borderless table-lg">
				...
				<tr class="signature-area" align="center">
					...
					<td colspan="2" class="smaller-height"><br><br><br>_____________________________________<br><br><B>DIVINE LOVE BOTE-BASILIO</B></td>
					<td colspan="2" class="smaller-height"><br><br><br>_____________________________________<br><br><B>DIVINE LOVE BOTE-BASILIO</B></td>
				</tr>
				<tr>
				...
				<tr class="smaller-height" style="border: 1px solid black"><td colspan="7"><center><B>Note: All Check Payments should be payable to DIVINE LOVE BOTE-BASILIO or BOTE ACCOUNTING AND TAXATION SERVICES</B></center></td></tr>
	        </table>
	    </div>
</div>
</body>