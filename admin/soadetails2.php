...
<html>
<head>
	<title>SOA Details | Approved</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="container">
						...
						<?php
							...
							while($rec=mysqli_fetch_assoc($result)){ 
								...
								<tr>
									...
									<td><a href="deletesoadetail2.php?id=<?php echo $rec['soa_details_id'];?>&soaid=<?php echo $soa_id;?>" class="btn btn-danger btn-sm">Delete</a></td>
								</tr>
						<?php
							}
		...
		<div class="row justify-content-center">
			...
			<a href="updatesoa2.php?id=<?php echo $soa_id;?>&amount=<?php echo $totalamount;?>" class="btn btn-primary btn-sm">Update</a>&nbsp;
			<a href="soaapproved.php" class="btn btn-sm btn-danger">Back</a>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="container-fluid">
								<form method="POST" action="addsoadetails2.php?id=<?php echo $soa_id;?>&suffix=<?php echo $soadate;?>">
