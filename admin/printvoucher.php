<?php
    ...
    $voucher_type_cash = $record['voucher_type_cash'];
    $voucher_type_check = $record['voucher_type_check'];
    $voucher_remarks1 = $record['voucher_remarks1'];
    $voucher_remarks2 = $record['voucher_remarks2'];
...
<div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-4">
			<?php
				echo "<br><b>Remarks:</b>"."<br>".$voucher_remarks1;
			?>
			</div>
			<div class="col-4">
			<?php
				echo "<br><b>Remarks:</b>"."<br>".$voucher_remarks2;
			?>
			</div>
			<div class="col-4">
			<?php
				echo "<br><b>Note:</b>"."<br>".$voucher_note;
			?>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<table class="table table-bordered" style="border: 3px solid black;">
				...
				<tr style="height: 100px;">
					...
					<td style="border: 3px solid black;"><?php echo $voucher_type_cash; ?></td>
					<td style="border: 3px solid black;"><?php echo $voucher_type_check; ?></td>
				...
				<tr>
					<td style="border: 3px solid black;"></td>
					<td style="border: 3px solid black;"></td>
					<td style="border: 3px solid black;" class="smaller-height" align="center"><b><?php echo $userfullname;?></b></td>
					<td style="border: 3px solid black;" class="smaller-height" align="center"><B>DIVINE LOVE BOTE-BASILIO</B></td>
					<td style="border: 3px solid black;"></td>
				</tr>
			</table>
		</div>
