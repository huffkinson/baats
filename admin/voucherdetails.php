			...
			<div class="col" style="border: 1px solid gray; padding: 10px 15px 10px 15px; border-radius: 10px;">
				<table class="col-12 table-sm" align="center">
					<?php
						...
						$getVoucherTypeCash = $row['voucher_type_cash'];
						$getVoucherTypeCheck = $row['voucher_type_check'];
						$getVoucherRemarks1 = $row['voucher_remarks1'];
						$getVoucherRemarks2 = $row['voucher_remarks2'];
						$getVoucherNote = $row['voucher_note'];
					?>
					<tr>
						<td>Ref#</td>
						<td>:</td>
					...
					<div class="row">
						<div class="col-3">
							<div class="form-group small-text-form">
								...
								<textarea class="form-control" type="textarea" name="voucher_type_cash" rows="1" style="min-width: 100%"><?php echo $getVoucherTypeCash; ?></textarea>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group small-text-form">
								<label class="control-label">Check</label>
								<textarea class="form-control" type="textarea" name="voucher_type_check" rows="1" style="min-width: 100%"><?php echo $getVoucherTypeCheck; ?></textarea>
							</div>
						</div>
					<!-- </div>
					<div class="row"> -->
						<div class="col-3">
							<div class="form-group small-text-form">
								...
								<textarea class="form-control" type="textarea" name="voucher_remarks1" rows="1" style="min-width: 100%"><?php echo $getVoucherRemarks1; ?></textarea>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group small-text-form">
								<label class="control-label">Remarks</label>
								<textarea class="form-control" type="textarea" name="voucher_remarks2" rows="1" style="min-width: 100%"><?php echo $getVoucherRemarks2; ?></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col">
							<div class="form-group small-text-form">
								...
								<textarea class="form-control" type="textarea" name="voucher_note" rows="1"><?php echo $getVoucherNote; ?></textarea>
							</div>
						</div>
					</div>
					<div class="row justify-content-center">
